    ...
    <div className="space-y-8 max-w-7xl mx-auto px-4 py-6 pb-20 text-slate-100 bg-slate-950 min-h-screen">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 rounded-3xl p-8 md:p-12 shadow-2xl border border-indigo-500/20">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <p className="text-slate-400 text-sm md:text-base font-semibold leading-relaxed max-w-2xl">
            {locale === 'ja'
      ...
      {/* Toolbar */}
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-4 md:p-6 shadow-xl flex flex-col gap-5">
            ...
            <div className="bg-slate-900 rounded-[2.5rem] w-full max-w-xl max-h-[85vh] overflow-hidden shadow-2xl flex flex-col border border-slate-800 animate-scale-up">
              ...
              <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-slate-950 border border-slate-850 p-5 rounded-3xl leading-relaxed text-sm md:text-base font-semibold text-slate-200 whitespace-pre-line shadow-inner">
              ...
              {/* Modal Footer */}
              <div className="p-6 md:px-8 md:py-6 border-t border-slate-800/80 bg-slate-900/30 flex justify-end">
                <button
                  onClick={() => setSelectedRune(null)}
