...
export default function ItemsPage() {
 ...
 {showHelp && (
 <div className="px-6 pb-6 pt-2 border-t border-slate-850/60 text-slate-300 text-xs font-semibold space-y-4 animate-fade-in">
 ...
 className="group bg-slate-900 border border-slate-800 rounded-2xl p-3 flex flex-col items-stretch text-left hover:scale-[1.03] hover:shadow-2xl hover:border-indigo-500/50 transition-all duration-300 relative overflow-hidden"
 >
 ...
 <div className="relative w-10 h-10 rounded-xl overflow-hidden bg-slate-950 border border-slate-800 shadow-inner group-hover:scale-105 transition-transform duration-300 shrink-0">
 <img 
 src={
 ...
 <h3 className="font-black text-slate-100 text-xs truncate group-hover:text-indigo-400 transition-colors">
 {item.nameJa}
 </h3>
 </div>
 <div className="flex items-center gap-1.5 mt-0.5">
 <span className="text-[9px] font-black text-amber-500 bg-amber-500/10 border border-amber-500/20 rounded-md px-1 py-0.5">
 {item.gold} G
 </span>
 {isOrnn && (
 <span className="text-[8px] font-black text-amber-400 bg-amber-400/20 border border-amber-400/30 rounded-md px-1 py-0.5 flex items-center gap-0.5">
 <Award size={9} />
 <span className="hidden">傑作</span>
 </span>
 )}
 </div>
 </div>
 ...
 {/* Stats overview */}
 <div className="space-y-1 mb-3 flex-1 z-10">
 {item.stats.length > 0 ? (
 item.stats.slice(0, 3).map((stat, idx) => (
 <div key={idx} className="text-[10px] text-slate-300 font-bold flex items-center gap-1 bg-slate-950/40 px-1.5 py-0.5 rounded-lg border border-slate-800/30">
 <span>{getStatEmoji(stat)}</span>
 <span className="truncate">{stat}</span>
 </div>
 ))
 ) : (
 <div className="text-[10px] text-slate-500 italic font-semibold">効果のみ</div>
 )}
 {item.stats.length > 3 && (
 <div className="text-[8px] text-indigo-400 font-black pl-5">
 ...
 <div className="border-t border-slate-800/60 pt-2 flex items-center justify-between text-[8px] text-slate-400 font-bold z-10">
 ...
 key={item.id}
 onClick={() => { setSelectedItem(item); setIsEditing(false); }}
 className="group bg-slate-900 border border-slate-800 rounded-xl p-3 flex items-center justify-between text-left hover:scale-[1.01] hover:shadow-lg hover:border-indigo-500/50 transition-all duration-200 relative overflow-hidden"
 >
 {/* Highlight Ornn Upgrade */}
 {isOrnn && (
 ...
 <div className="relative w-10 h-10 rounded-lg overflow-hidden bg-slate-950 border border-slate-800 shadow-inner group-hover:scale-105 transition-transform duration-300 shrink-0">
 <img 
 src={
 item.image === 'default_item.png'
 ? 'https://ddragon.leagueoflegends.com/cdn/14.8.1/img/item/1055.png'
 ...
 <h3 className="font-black text-slate-100 text-sm truncate group-hover:text-indigo-400 transition-colors">
 {item.nameJa}
 </h3>
 <div className="flex items-center gap-1.5 mt-0.5">
 <span className="text-[9px] font-black text-amber-500 bg-amber-500/10 border border-amber-500/20 rounded px-1 py-0.5">
 {item.gold} G
 </span>
 {isOrnn && (
 <span className="text-[8px] font-black text-amber-400 bg-amber-400/20 border border-amber-400/30 rounded px-1 py-0.5 flex items-center gap-0.5">
 <Award size={8} />
 <span>傑作</span>
 </span>
 )}
 ...
 <div className="flex flex-wrap items-center gap-1 z-10 mt-2 w-full">
 ...
 <div 
 key={idx} 
 className={`relative border rounded-3xl p-5 space-y-2 bg-gradient-to-r transition-all duration-300 ${
 isActive 
 ...
 <div className="bg-slate-950/60 border border-amber-500/20 rounded-3xl p-5 space-y-6">
