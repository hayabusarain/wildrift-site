...
export default function ItemsClient() {
  ...
  return (
    <div className="max-w-md mx-auto bg-slate-50 min-h-screen pb-24 font-sans text-slate-800">
      ...
      {selectedItem && (
        <div 
          className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4 transition-opacity"
          onClick={(e) => {
        ...
        >
          <div className="bg-white w-full max-w-md max-h-[90vh] rounded-3xl shadow-2xl flex flex-col relative animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 pb-6 space-y-8 bg-slate-50">
